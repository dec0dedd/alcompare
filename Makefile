run_app:
	...
	wget -r -np -nH -A "async-*" http://127.0.0.1:8050/_dash-component-suites/dash/dcc/
	wget -r -np -nH -A "async-*" http://127.0.0.1:8050/_dash-component-suites/dash/dash_table/
